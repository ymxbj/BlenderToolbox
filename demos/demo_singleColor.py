...
# mesh_dir = f'/data/xiongbj/BlenderToolbox/display_{category}_unit'
mesh_dir = '/data/xiongbj/BlenderToolbox/shape_novelty/4165'

# output_dir = f'/data/xiongbj/BlenderToolbox/{category}_images'
output_dir = f'/data/xiongbj/BlenderToolbox/4165'
...
for mesh in meshes:
    ...
    meshColor = bt.colorObj(eval(f'bt.{category}'), 0.5, 1.0, 1.0, 0.0, 2.0)
    AOStrength = 0.0
    ...
    focalLength = 135 # (UI: click camera > Object Data > Focal Length)
